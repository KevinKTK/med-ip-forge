...
const mockProjects = [
  {
    ...
    detailed_description: "Our AI-powered music composition system uses advanced machine learning algorithms to analyze emotional inputs and create unique musical pieces. The system can understand various emotional states and translate them into complex musical arrangements, incorporating multiple instruments and styles. This technology aims to revolutionize how we create and experience music in the digital age.",
    images: [],
    owner_wallet_address: "0x0b1e46e42c49f450aF30769C4BC2a3CF0425A8c1",
  ...
  },
  {
    ...
    detailed_description: "This groundbreaking NFT collection features 100 unique digital art pieces that seamlessly integrate with augmented reality technology. Each piece is created using a combination of traditional artistic techniques and cutting-edge digital tools. The AR integration allows collectors to experience the artwork in their physical space, creating an immersive viewing experience that bridges the gap between digital and physical art.",
    images: [],
    owner_wallet_address: "0x0b1e46e42c49f450aF30769C4BC2a3CF0425A8c1",
    project_status: "published",
    risk_level: "Low",
  ...
  },
  {
    ...
    detailed_description: "Our interactive storytelling platform revolutionizes the way stories are created and consumed. Writers can craft branching narratives with multiple storylines and endings, while readers can make choices that affect the story's outcome. The platform includes advanced AI tools for story generation, character development, and plot consistency checking. This project aims to create a new form of digital literature that combines traditional storytelling with modern technology.",
    images: [],
    owner_wallet_address: "0x0b1e46e42c49f450aF30769C4BC2a3CF0425A8c1",
    project_status: "published",
    risk_level: "High",
